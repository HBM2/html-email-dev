...
module.exports = function() {
    return through.obj(function(file, encoding, callback) {
        ...
        if (file.isStream()) {
            ...
            var buildComment = '<!-- THIS FILE WAS AUTOGENERATED! DONT EDIT THIS! TO EDIT: open corresponding template in hbm-email-dev project from github! built by ' + username.sync() + ' on ' + moment().toString() + ' -->';
